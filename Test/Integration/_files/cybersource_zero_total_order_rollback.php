...
$orders = $orderCollectionFactory->create()
    ->addFieldToFilter('increment_id', '100000575');
 ...
 * also destroy the cards owned by the sibling fixtures (cybersource_cron_cards.php et al).
 */
...
$cards = $cardCollectionFactory->create()
    ->addFieldToFilter('customer_email', 'zero-total-card@example.com');
