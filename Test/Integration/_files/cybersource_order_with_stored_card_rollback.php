...
$orders = $orderCollectionFactory->create()
    ->addFieldToFilter('increment_id', ['in' => ['100000560', '100000561']]);
...
/**
 * Delete ONLY this fixture's card. Filtering on method alone would also destroy the cards owned by the
 * sibling cron fixtures (cybersource_cron_cards.php), which share the paradoxlabs_cybersource method.
 */
...
$cards = $cardCollectionFactory->create()
    ->addFieldToFilter('customer_email', 'stored-card@example.com');
