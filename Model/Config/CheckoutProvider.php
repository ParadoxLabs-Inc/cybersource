...
class ConfigProvider extends CcGenericConfigProvider
{
    ...
    protected function getIframeParams()
    {
        ...
        $signedParams = [
            ...
            'override_custom_cancel_page' => $this->urlBuilder->getUrl('pdl_cybs/secureaccept/cancel'),
            'override_custom_receipt_page' => $this->urlBuilder->getUrl('pdl_cybs/secureaccept/complete'),
